	...
	<body>
		...
		<div id='sidebar'>
			<ul>
				...
				<li><a href='loginCheck.php'>Add Entry</a></li>
			</ul>
			...
			<br>
			<form action='logOutPro.php' method='POST' id='myForm'>
				<input name = 'logout' type='submit' value='Logout' onclick="alert('You have successfully logged out!')">
			</form>
		</div>
	</body>
</html>